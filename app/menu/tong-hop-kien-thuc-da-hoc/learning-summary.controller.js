...
function LearningSummaryCtrl($scope, $rootScope, LearningSummaryService) {
    ...
    $scope.name_variations_list = [
        {
            id_variation: "answer1", name_variation: "Number of characters", result_variation: $scope.answer1
        }, {
            id_variation: "answer2", name_variation: "First character", result_variation: $scope.answer2
        }, {
            id_variation: "answer3", name_variation: "Last character", result_variation: $scope.answer3
        }, {
            id_variation: "answer4", name_variation: "Lower case", result_variation: $scope.answer4
        }, {
            id_variation: "answer5", name_variation: "Upper case", result_variation: $scope.answer5
        }, {
            id_variation: "answer6", name_variation: "Capitalize", result_variation: $scope.answer6
        }, {
            id_variation: "answer7", name_variation: "Without leading \n and trailing spaces", result_variation: $scope.answer7
        },];
